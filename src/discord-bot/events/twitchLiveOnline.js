...
const execute = async (client) => {
  ...
  try {
    ...
    const streamInfo = await twitchApi.getStreamInfo(client.liveEvent.broadcaster_user_id);
    const streamTitle = streamInfo?.title || `${client.liveEvent.broadcaster_user_name} is Live!!`;
